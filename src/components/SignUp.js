  ...
  const handleSignUp = (e) => {
   ...
   return (
     <div className='fixed top-0 left-0 right-0 bottom-0 z-50 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      <form onSubmit={handleSignUp} className='relative bg-white p-10 rounded-xl text-slate-500 w-96 max-w-[90%]'>
        ...
        <p className='mt-5 text-center'>Already have an account? <span className='text-blue-600 cursor-pointer' onClick={onBackToLogin}>Login</span></p>
